...
const Disclaimer = () => {
  return (
    <div style={textualStyle}>
      ...
      <h4 style={{ color: 'var(--gold)', marginTop: '25px', marginBottom: '10px' }}>1. Accuracy of Materials</h4>
      ...
      <h4 style={{ color: 'var(--gold)', marginTop: '25px', marginBottom: '10px' }}>2. Payment Processing Restrictions</h4>
      <p style={{ marginBottom: '15px' }}>
      ...
      <h4 style={{ color: 'var(--gold)', marginTop: '25px', marginBottom: '10px' }}>3. External Binding Links</h4>
      <p style={{ marginBottom: '15px' }}>
